      ...
      <div className="frame5-frame5">
        <div className="frame5-products">
          ...
          <div className="frame5-filters">
            <div className="frame5-search-suggest-outline-l-statement1active">
              <div className="frame5-container1">
                <span className="frame5-text014">
                  <span>Search</span>
                </span>
              </div>
              <img
                src="/playground_assets/searchi161-79kj.svg"
                alt="searchI161"
                className="frame5-search"
              />
            </div>
            <div className="frame5-filter">
              <img
                src="/playground_assets/filteri272-ghs4.svg"
                alt="filterI272"
                className="frame5-filter1"
              />
            </div>
          </div>
        ...
        <div className="frame5-storeinfo">
          ...
          <span className="frame5-text098">
            <span>9 MURRAY ST NEW YORK NY</span>
          </span>
          <span className="frame5-text100">
            <span>Opening hours: 10:00-22:00</span>
          </span>
        ...
        <div className="frame5-header">
          <div className="frame5-logo">
            <img
              src="/playground_assets/pomegranate1i275-tbnm-200h.png"
              alt="pomegranate1I275"
              className="frame5-pomegranate1"
            />
            <span className="frame5-text123">
              <span className="frame5-text124">P</span>
              <span className="frame5-text125">o</span>
              <span>me Granate</span>
            </span>
          </div>
          <div className="frame5-menu">
            <div className="frame5-allstores">
              <span className="frame5-text127">
                <span>All stores</span>
              </span>
            </div>
            <div className="frame5-allstores1">
              <span className="frame5-text129">
                <span>Workers</span>
              </span>
            </div>
            <div className="frame5-allstores2">
              <span className="frame5-text131">
                <span>Storages</span>
              </span>
            </div>
            <div className="frame5-allstores3">
              <span className="frame5-text133">
                <span>Order List</span>
              </span>
            </div>
          </div>
          <div className="frame5-icons">
            <img
              src="/playground_assets/settingsi275-uq2.svg"
              alt="settingsI275"
              className="frame5-settings"
            />
            <img
              src="/playground_assets/belli275-8257.svg"
              alt="bellI275"
              className="frame5-bell"
            />
          </div>
          <div className="frame5-maskgroup8">
            <img
              src="/playground_assets/ellipse37i275-sof-200h.png"
              alt="Ellipse37I275"
              className="frame5-ellipse37"
            />
            <img
              src="/playground_assets/unsplashznhrntwxg6qi275-xsqd-200h.png"
              alt="unsplashZnHRNtwXg6QI275"
              className="frame5-unsplash-zn-h-r-ntw-xg6q"
            />
          </div>
        </div>
      </div>
